$port = if (Test-Path 'C:\Users\srath\Downloads\16-10-2025\.dual-graph\mcp_port') { Get-Content 'C:\Users\srath\Downloads\16-10-2025\.dual-graph\mcp_port' } else { '8080' }
try {
...
$ctxFile = 'C:\Users\srath\Downloads\16-10-2025\CONTEXT.md'
if (Test-Path $ctxFile) { Write-Output ""; Write-Output "=== CONTEXT.md ==="; Get-Content $ctxFile -Raw; Write-Output "=== end CONTEXT.md ===" }
$storeFile = 'C:\Users\srath\Downloads\16-10-2025\.dual-graph\context-store.json'
