...
import com.aipoweredgita.app.ui.screens.auth.SplashScreen
import com.aipoweredgita.app.ui.screens.auth.ExitScreen
import com.aipoweredgita.app.ui.main.MainScreen
        ...
        lifecycleScope.launch(Dispatchers.Default) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    // Schedule background bot for offline syncs
                    com.aipoweredgita.app.services.SyncWorker.schedule(applicationContext)
                    com.aipoweredgita.app.services.SyncWorker.schedulePeriodic(applicationContext)
                }
            } catch (e: Exception) {
